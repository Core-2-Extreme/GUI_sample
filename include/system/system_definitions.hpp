...
#define DEF_DRAW_X_ALGIN_LEFT 0
#define DEF_DRAW_X_ALGIN_CENTER 1
#define DEF_DRAW_X_ALGIN_RIGHT 2
#define DEF_DRAW_Y_ALGIN_TOP 0
#define DEF_DRAW_Y_ALGIN_CENTER 1
#define DEF_DRAW_Y_ALGIN_BOTTOM 2
