...
#define DEF_SEM_MENU_TOP 0
#define DEF_SEM_MENU_UPDATE 1
#define DEF_SEM_MENU_LANGAGES 2
#define DEF_SEM_MENU_LCD 3
#define DEF_SEM_MENU_CONTROL 4
#define DEF_SEM_MENU_FONT 5
#define DEF_SEM_MENU_WIFI 6
#define DEF_SEM_MENU_ADVANCED 7
#define DEF_SEM_MENU_BATTERY 8
#define DEF_SEM_MENU_RECORDING 9
