...
#define DEF_STACKSIZE						(uint32_t)(64 * 1024)
#define DEF_INACTIVE_THREAD_SLEEP_TIME		(uint64_t)(100000)
#define DEF_ACTIVE_THREAD_SLEEP_TIME		(uint64_t)(50000)
...
#define DEF_SYSTEM_THREAD_PRIORITY_IDLE		(int32_t)(0x3F)	//Lowest priority for system thread, user thread must not use this priority.
#define DEF_SYSTEM_THREAD_PRIORITY_REALTIME	(int32_t)(0x18)	//Highest priority for system thread, user thread must not use this priority.
